...
const changeHeaderOnScroll = function() {
  ...
  (function() {
    ...
    myCollapseEl.addEventListener('show.bs.collapse', function () {
      ...
      document.querySelector('.mob-wrapper').style.overflow = 'hidden';
      document.querySelector('.mob-wrapper').style.height = '100vh';
    ...
    myCollapseEl.addEventListener('hide.bs.collapse', function () {
      ...
      document.querySelector('.mob-wrapper').removeAttribute('style');
      for (let el of closedElements) {
  ...
  //Show mobile catalog
  const showCatalogMenu = function() {
    const toggleMenu = document.querySelector('.nav-mobile h4');
    const catalogMenu = document.querySelector('.nav-mobile .nav-side');
    toggleMenu.onclick = function() {
      ...
      if (toggleMenu.classList.contains('open')) {
        ...
        document.querySelector('.navbar-toggler').removeAttribute('style');
      }
    }
  }
  showCatalogMenu();
  ...
  (function() {
    ...
    const deliveryForms = payForm.querySelectorAll('.pay__block');
  ...
  //Profil scripts
  (function() {
    const profilOderItems = document.querySelectorAll('.profil-oder__item');
    if (!profilOderItems) {
      return;
    }
  
    for (let item of profilOderItems) {
        item.onclick = function() {
        setTimeout(function() {
          const child = item.querySelector('.profil-oder__body');
  ...
  (function() {
    const profilSort = document.querySelectorAll('.profil-sort-menu .dropdown-item');
    if (!profilSort) {
      return;
    }
    
    for (let item of profilSort) {
        item.onclick = function() {
        profilSort.forEach(element => {
  ...
  const formDelivery = function() {
    var input = document.getElementById("pay-city");
    var list = input.nextElementSibling;
    var options = list.childNodes;
    const formResult = document.getElementById('citydata');
    if(!input) {
      return
    }
    input.onclick = function() {
      formResult.innerHTML = input.value;
      for(var i = 0; i < options.length; i++) {
        if(options[i].innerText === input.value) {
          formResult.value = input.value;
        }
      }
    }
